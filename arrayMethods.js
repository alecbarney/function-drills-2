...
const ordersTaxTotal = orders.map(num => num.price * num.tax + num.price)

// console.log(ordersTaxTotal)
...
const bobsTotal = purchases.filter(prsn => prsn.owner === 'Bob').reduce((x,y)=> x + y.price, 0)
